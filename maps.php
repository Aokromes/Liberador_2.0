...
return [
    ...
    42=>"Collin's Test",43=>"Wailing Caverns",44=>"<unused> Monastery",
    47=>"Razorfen Kraul",48=>"Blackfathom Deeps",70=>"Uldaman",
    90=>"Gnomeregan",109=>"Sunken Temple",129=>"Razorfen Downs",
    ...
    451=>"Development Land",469=>"Blackwing Lair",489=>"Warsong Gulch",
    509=>"Ruins of Ahn'Qiraj",529=>"Arathi Basin",530=>"Outland",
    531=>"Ahn'Qiraj Temple",532=>"Karazhan",533=>"Naxxramas",
    534=>"The Battle for Mount Hyjal",540=>"The Shattered Halls",
    542=>"The Blood Furnace",543=>"Hellfire Ramparts",
    ...
    558=>"Auchenai Crypts",559=>"Nagrand Arena",
    560=>"The Escape From Durnholde",562=>"Blade's Edge Arena",
    ...
    578=>"The Oculus",580=>"The Sunwell",585=>"Magister's Terrace",
    595=>"The Culling of Stratholme",599=>"Halls of Stone",
    600=>"Drak'Tharon Keep",601=>"Azjol-Nerub",602=>"Halls of Lightning",
    603=>"Ulduar",604=>"Gundrak",607=>"Strand of the Ancients",
    608=>"Violet Hold",609=>"Ebon Hold",615=>"The Obsidian Sanctum",
    616=>"The Eye of Eternity",617=>"Dalaran Sewers",
    618=>"The Ring of Valor",619=>"Ahn'kahet: The Old Kingdom",
    624=>"Vault of Archavon",628=>"Isle of Conquest",
    631=>"Icecrown Citadel",632=>"Forge of Souls",
    649=>"Trial of the Crusader",650=>"Trial of the Champion",
    658=>"Pit of Saron",668=>"Halls of Reflection"
];
